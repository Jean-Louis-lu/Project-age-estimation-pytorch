...
def get_args():
    ...
    parser.add_argument("--resume", type=str, help="Model weight to be tested",default= "D:/Python_jupyter_file/MAP583/Project-age-estimation-pytorch/checkpoint/epoch046_0.19438_4.4367.pth")
