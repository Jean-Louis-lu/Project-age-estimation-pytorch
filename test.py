...
def get_args():
    ...
    parser.add_argument("--resume", type=str, help="Model weight to be tested",default= "D:/Python_jupyter_file/MAP583/Project-age-estimation-pytorch/checkpoint/epoch045_0.18424_4.0290.pth")
